...
public class AnswerServices {
	...
	public Answer findAnswerById(int id) throws EntityRequestException{
		...
		try {
			...
			throw new EntityRequestException("Could not find an answer by id :: " + id);
		}
		return answer;
	}
	...
	public List<Answer> findAnswersByUser(User user) throws EntityRequestException{
		...
		try {
			...
			throw new EntityRequestException("Could not find answers by Userid, username :: " + user.getId()
																						+" " + user.getUsername());
		}
	...
	public List<Answer> findAnswersByConversation(Conversation conversation) throws EntityRequestException{
		...
		try {
			...
			throw new EntityRequestException("Could not find answers by Conversation id :: " + conversation.getId());
		}
	...
	public List<Answer> findByConversationAndUser(Conversation conversation, User user) throws EntityRequestException{
		...
		try {
			...
			throw new EntityRequestException("Could not find answers by Conversation id & User id :: " + conversation.getId()
